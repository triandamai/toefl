                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-notification nav-item">
                            ...
                            <ul class="dropdown-menu dropdown-menu-media dropdown-cart dropdown-menu-right">
                                ...
                                <li class="scrollable-container media-list"><a class="cart-item" href="app-ecommerce-details.html">
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="<?= base_url();?>assets/app-assets/images/pages/eCommerce/4.png" width="75" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="<?= base_url();?>assets/app-assets/images/pages/eCommerce/dell-inspirion.jpg" width="100" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="<?= base_url();?>assets/app-assets/images/pages/eCommerce/7.png" width="88" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="<?= base_url();?>assets/app-assets/images/pages/eCommerce/10.png" width="75" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="<?= base_url();?>assets/app-assets/images/pages/eCommerce/sony-75class-tv.jpg" width="100" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="<?= base_url();?>assets/app-assets/images/pages/eCommerce/canon-camera.jpg" width="70" alt="Cart Item"></div>
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                ...
                                <span>
                                    <img class="round" src="<?= base_url();?>assets/app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40">
                                </span>
                            </a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?= base_url();?>assets/html/ltr/vertical-menu-template/index.html">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
               ...
               foreach($config->menu as $menu){
                   if($menu->type == "1"){
                    ?>
                    <li class=" nav-item">
                        <a href="index.html"><i class="<?= $menu->icon;?>"></i>
                        <span class="menu-title" data-i18n="Dashboard"><?= $menu->judul;?></span>
                    ...
                    <li class=" nav-item">
                        <a href="#"><i class="<?= $menu->icon;?>"></i>
                            <span class="menu-title" data-i18n="Ecommerce"><?= $menu->judul;?></span>
                        </a>
                        <ul class="menu-content">
                            ...
                            <li>
                               <a href="app-ecommerce-shop.html">
                                   <i class="<?= $sub->icon;?>"></i>
                                   <span class="menu-item" data-i18n="Shop"><?= $sub->judul;?></span>
                                </a>
                            </li>
                           <?php }?>
                        </ul>
                    ...
                    ?>
                    <li class=" nav-item">
                        <a href="app-email.html"><i class="<?= $menu->icon;?>"></i>
                            <span class="menu-title" data-i18n="Email"><?= $menu->judul;?></span>
                        </a>
                    </li>
                    <?php
                    }else if($menu->type == "4"){
                    ?>
                     <li class=" navigation-header"><span><?= $menu->judul;?></span></li>
                    <?php
                   }else{
