    ...
    <div class="horizontal-menu-wrapper">
        ...
        foreach($config->menu as $menu){
            if($menu->type == "1"){
             ?>
                            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="index.html" data-toggle="dropdown"><i class="<?= $menu->icon;?>"></i><span data-i18n="Dashboard"><?= $menu->judul;?></span></a>
                        <ul class="dropdown-menu">
                            <li class="active" data-menu=""><a class="dropdown-item" href="dashboard-analytics.html" data-toggle="dropdown" data-i18n="Analytics"><i class="feather icon-activity"></i><?= $menu->judul;?></a>
                            </li>
